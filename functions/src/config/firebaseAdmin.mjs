...
const serviceAccount = path.resolve('src/config', 'firebase-admin-sdk.json'); // Asegúrate de que el archivo .json esté en la carpeta 'config'

// Inicializa Firebase Admin SDK con las credenciales de servicio
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  storageBucket: 'portafolio-9252d.firebasestorage.app',  // El bucket de Firebase Storage
});
